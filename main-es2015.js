...
class ErrorInterceptor {
    constructor(router, loginService, signalRService) {
        this.router = router;
        ...
        if (!this.isRefreshing) {
            ...
            return this.loginService.refreshToken(obj).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])((token) => {
                ...
                if (token.result === 'Success') {
                    this.loginService.setData('accessToken', token.accessToken);
...
class SignalRService {
    constructor(http) {
        ...
        this.startConnection = () => {
            this.groupName = JSON.parse(sessionStorage['user']).userName;
            //this.groupName = sessionStorage['userID'];
        ...
        this.removeFromGroup = () => {
            if (this.hubConnection) {
                ...
                this.hubConnection.invoke('RemoveFromALLGroup', JSON.parse(localStorage['user']).userName)
...
SignalRService.ɵfac = function SignalRService_Factory(t) { return new (t || SignalRService)(_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"])); };
